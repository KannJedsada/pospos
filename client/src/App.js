    ...
    <AuthProvider>
      <Router>
        <Routes>
          ...
          {/* manager and owner */}
          <Route element={<PrivateRoute access={[0, 1, 2]} />}>
            <Route path="/manager" element={<Manager />} />
            <Route path="/checkin" element={<Checkin />} />
            <Route path="/checkout" element={<Checkout />} />
            <Route path="/empmanagement" element={<EmpManagement />} />
          ...
          {/* kitchen  and owner */}
          <Route element={<PrivateRoute access={[0, 1, 3]} />}>
            <Route path="/kitchen" element={<Kitchen />} />
            <Route path="/orderdinks" element={<Orderdinks />} />
            <Route path="/material" element={<MaterialPage />} />
            <Route path="/addmaterial" element={<Addmaterial />} />
          ...
          {/* owner */}
          <Route element={<PrivateRoute access={[0, 1]} />}>
            <Route path="/department" element={<DeptManagement />} />
            <Route path="/position" element={<Position />} />
            <Route path="/addposition" element={<AddPosition />} />
            <Route path="/editposition" element={<Editposition />} />
          ...
          {/* casheir and owner */}
          <Route element={<PrivateRoute access={[0, 1, 4]} />}>
            <Route path="/order" element={<Order />} />
            <Route path="/ordered" element={<Ordered />} />
            <Route path="/receipt" element={<Receipt />} />
            <Route path="/allreeipt" element={<Allreceipt />} />
